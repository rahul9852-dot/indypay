        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr]">
          ...
          <div className="bg-linear-to-br from-[#f5f0fd] to-white p-8 lg:p-10 flex flex-col justify-between">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-semibold text-slate-700">support@rupeeflow.co</div>
                  </div>
                </div>
            ...
            <div className="mt-10 flex flex-wrap gap-2">
              {['PCI DSS Certified', 'RBI Compliant', '50,000+ Businesses'].map((b) => (
                <span key={b} className="px-3 py-1 rounded-full bg-white border border-[#7B4DB5]/20 text-[#7B4DB5] text-[10px] font-bold">
                  {b}
                </span>
              ))}
            </div>
