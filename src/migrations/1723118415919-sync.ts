...
export class Sync1723118415919 implements MigrationInterface {
    name = 'Sync1723118415919'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" character varying NOT NULL, "fullName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying, "mobile" character varying NOT NULL, "isKycVerified" boolean NOT NULL DEFAULT false, "is2FAEnabled" boolean NOT NULL DEFAULT false, "secret2FA" character varying, "status" integer NOT NULL DEFAULT '1', "role" integer NOT NULL DEFAULT '2', "onboardingStatus" integer NOT NULL DEFAULT '1', "businessDetailsId" character varying NOT NULL, "address" character varying, "city" character varying, "state" character varying, "pincode" character varying, "aadhar" character varying, "pan" character varying, "image" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_d376a9f93bba651f32a2c03a7d3" UNIQUE ("mobile"), CONSTRAINT "REL_abfb8b60c24e6e22a6b0b8f18e" UNIQUE ("businessDetailsId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id")); COMMENT ON COLUMN "users"."fullName" IS 'merchant name as per pan card'; COMMENT ON COLUMN "users"."isKycVerified" IS 'kyc will verify on verify.paybolt.in with aadhar & pan'; COMMENT ON COLUMN "users"."is2FAEnabled" IS '2FA'; COMMENT ON COLUMN "users"."secret2FA" IS '2FA secret'`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_97672ac88f789774dd47f7c8be" ON "users" ("email") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_d376a9f93bba651f32a2c03a7d" ON "users" ("mobile") `);
        await queryRunner.query(`CREATE TABLE "onboarding_users" ("id" character varying NOT NULL, "fullName" character varying NOT NULL, "email" character varying NOT NULL, "mobile" character varying NOT NULL, "businessName" character varying NOT NULL, "designation" character varying NOT NULL, "otplessId" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ebd5f3319f6d61efa2a9f746cde" UNIQUE ("email"), CONSTRAINT "UQ_51402299074b7f4ebf84b05ec20" UNIQUE ("mobile"), CONSTRAINT "PK_e117a44844b303a62cda4c97a63" PRIMARY KEY ("id")); COMMENT ON COLUMN "onboarding_users"."fullName" IS 'merchant name as per pan card'`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_51402299074b7f4ebf84b05ec2" ON "onboarding_users" ("mobile") `);
        await queryRunner.query(`CREATE TABLE "internal_users" ("id" character varying NOT NULL, "fullName" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying, "mobile" character varying NOT NULL, "status" integer NOT NULL DEFAULT '1', "role" integer NOT NULL DEFAULT '1', "is2FAEnabled" boolean NOT NULL DEFAULT false, "secret2FA" character varying, "image" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_b7d7c019ae2f3c6922a05586019" UNIQUE ("email"), CONSTRAINT "UQ_56c029f4522a4a6351bd6ce9610" UNIQUE ("mobile"), CONSTRAINT "PK_2d59d7927ab38048afb534f00b3" PRIMARY KEY ("id")); COMMENT ON COLUMN "internal_users"."is2FAEnabled" IS '2FA'; COMMENT ON COLUMN "internal_users"."secret2FA" IS '2FA secret'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_51402299074b7f4ebf84b05ec2"`);
        await queryRunner.query(`DROP TABLE "onboarding_users"`);
