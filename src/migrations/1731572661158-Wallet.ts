...
export class Wallet1731572661158 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "wallets" ("id" character varying NOT NULL, "totalCollections" numeric(15,2) NOT NULL DEFAULT '0', "totalPayouts" numeric(15,2) NOT NULL DEFAULT '0', "totalBalance" numeric(15,2) NOT NULL DEFAULT '0', CONSTRAINT "PK_8402e5df5a30a229380e83e4f7e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "users" ADD "walletId" character varying`);
