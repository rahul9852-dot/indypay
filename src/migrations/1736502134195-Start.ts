...
export class Start1736502134195 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "user_api_keys" ("id" character varying NOT NULL, "clientId" character varying NOT NULL, "clientSecret" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" character varying, CONSTRAINT "PK_978fa5caa3468f463dac9d92e69" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "user_multi_factor_auth" ("id" character varying NOT NULL, "secret" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_c7919726b93b2e1710000d5b0e0" PRIMARY KEY ("id")); COMMENT ON COLUMN "user_multi_factor_auth"."secret" IS '2FA secret'`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "user_business_details" ("id" character varying NOT NULL, "businessPan" character varying, "businessEntityType" integer NOT NULL, "businessName" character varying NOT NULL, "registerBusinessNumber" character varying NOT NULL, "designation" character varying NOT NULL, "turnover" integer NOT NULL, "businessIndustry" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_0f007b75f6ef843518f194a35bc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "settlements" ("id" character varying NOT NULL, "amount" numeric(10,2) NOT NULL, "transferMode" character varying NOT NULL DEFAULT 'IMPS', "status" character varying NOT NULL DEFAULT 'PENDING', "transferId" character varying, "remarks" character varying, "successAt" TIMESTAMP WITH TIME ZONE, "failureAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" character varying, "bankDetailsId" character varying, "settledById" character varying, CONSTRAINT "PK_5f523ce152b84e818bff9467aab" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "user_bank_details" ("id" character varying NOT NULL, "name" character varying NOT NULL, "email" character varying NOT NULL, "mobile" character varying NOT NULL, "bankName" character varying NOT NULL, "bankIFSC" character varying NOT NULL, "accountNumber" character varying NOT NULL, "userId" character varying, CONSTRAINT "PK_6d4c4e4f554aea8154590b14d94" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "user_media" ("id" character varying NOT NULL, "documentType" character varying NOT NULL, "documentUrl" character varying NOT NULL, "documentName" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "kycId" character varying, CONSTRAINT "PK_70554748248e1812b2dd205a24c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "user_kyc" ("id" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_96852e5a0116c49c1507faae57a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
