...
export class Wallet1731574977800 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "settlements" ADD "settledById" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "settlements" ADD CONSTRAINT "UQ_ba40101ac8dfb96097f9d6bc0c4" UNIQUE ("settledById")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "settlements" DROP CONSTRAINT "UQ_ba40101ac8dfb96097f9d6bc0c4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "settlements" DROP COLUMN "settledById"`,
    );
  }
}
