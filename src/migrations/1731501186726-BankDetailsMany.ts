...
export class BankDetailsMany1731501186726 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "REL_cc48328e01a0d330f35c7c4332"`,
    );
    await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "bankDetailsId"`);
    await queryRunner.query(
      `ALTER TABLE "user_bank_details" ADD "userId" character varying`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_bank_details" DROP COLUMN "userId"`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD "bankDetailsId" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "REL_cc48328e01a0d330f35c7c4332" UNIQUE ("bankDetailsId")`,
    );
    await queryRunner.query(
