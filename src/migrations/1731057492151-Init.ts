...
export class Init1731057492151 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_api_keys" ("id" character varying NOT NULL, "clientId" character varying NOT NULL, "clientSecret" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" character varying, CONSTRAINT "PK_978fa5caa3468f463dac9d92e69" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_multi_factor_auth" ("id" character varying NOT NULL, "secret" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c7919726b93b2e1710000d5b0e0" PRIMARY KEY ("id")); COMMENT ON COLUMN "user_multi_factor_auth"."secret" IS '2FA secret'`);
        await queryRunner.query(`CREATE TABLE "user_business_details" ("id" character varying NOT NULL, "businessEntityType" integer NOT NULL, "businessName" character varying NOT NULL, "designation" character varying NOT NULL, "turnover" integer NOT NULL, "industry" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0f007b75f6ef843518f194a35bc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_kyc" ("id" character varying NOT NULL, "kycStatus" integer NOT NULL DEFAULT '1', "pan" character varying, "aadhar" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_96852e5a0116c49c1507faae57a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "auth_otp" ("id" character varying NOT NULL, "code" character varying(6) NOT NULL, "mobile" character varying NOT NULL, "expiredAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_2c699378068abaea9eff84e9ec3" UNIQUE ("mobile"), CONSTRAINT "PK_06c70acc09e7cb64b282d37e139" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "user_api_keys" ADD CONSTRAINT "FK_e131705cbbc8fb589889b02d457" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "payout_orders" ADD CONSTRAINT "FK_43a99b6a22cbe5a0c511ff11b84" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_56253ef17752a6d04ecee9ec9c5" FOREIGN KEY ("payInOrderId") REFERENCES "payin_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_3abe8c03b9c4ebcc1db34f5d0eb" FOREIGN KEY ("payOutOrderId") REFERENCES "payout_orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "payin_orders" ADD CONSTRAINT "FK_cfc9049095f9e4c6d9fd549747d" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_abfb8b60c24e6e22a6b0b8f18ef" FOREIGN KEY ("businessDetailsId") REFERENCES "user_business_details"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_02f203b01625d8dab98d7916329" FOREIGN KEY ("multiFactorAuthId") REFERENCES "user_multi_factor_auth"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_8d7891ecc41ac3858a5f477afc7" FOREIGN KEY ("kycId") REFERENCES "user_kyc"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_02f203b01625d8dab98d7916329"`);
        ...
        await queryRunner.query(`ALTER TABLE "payin_orders" DROP CONSTRAINT "FK_cfc9049095f9e4c6d9fd549747d"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_6bb58f2b6e30cb51a6504599f41"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_74f9b62467d421dda349ce80c02"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_3abe8c03b9c4ebcc1db34f5d0eb"`);
        await queryRunner.query(`ALTER TABLE "transactions" DROP CONSTRAINT "FK_56253ef17752a6d04ecee9ec9c5"`);
        await queryRunner.query(`ALTER TABLE "payout_batches" DROP CONSTRAINT "FK_affa903702963d0959d83a181ac"`);
        await queryRunner.query(`ALTER TABLE "payout_orders" DROP CONSTRAINT "FK_43a99b6a22cbe5a0c511ff11b84"`);
        await queryRunner.query(`ALTER TABLE "user_address" DROP CONSTRAINT "FK_1abd8badc4a127b0f357d9ecbc2"`);
        await queryRunner.query(`ALTER TABLE "user_api_keys" DROP CONSTRAINT "FK_e131705cbbc8fb589889b02d457"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_7af9214b2eb46ca058a0cd7422"`);
